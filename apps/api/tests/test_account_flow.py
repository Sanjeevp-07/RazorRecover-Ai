...
async def test_full_account_lifecycle():
    ...
    async with AsyncClient(transport=transport, base_url="http://testserver") as client:
        ...
        reg_payload = {
            ...
            "email": "unique_merchant_123@example.com",
        ...
        assert data_reg["user"]["email"] == "unique_merchant_123@example.com"
        ...
        assert data_login["user"]["email"] == "unique_merchant_123@example.com"
