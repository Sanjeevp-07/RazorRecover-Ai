    ...
    <div className="min-h-[80vh] flex items-center justify-center">
      <div className="w-full max-w-md p-8 glass-card rounded-2xl border border-slate-800 shadow-2xl space-y-6">
        <div className="text-center">
          ...
          <p className="text-xs text-slate-400 mt-1">Start automated AI revenue recovery for your store</p>
        </div>
        ...
        <button
          ...
          className="w-full py-3 px-4 rounded-xl bg-slate-900 hover:bg-slate-800 border border-slate-700/80 font-semibold text-xs text-slate-200 flex items-center justify-center gap-3 transition-all hover:border-slate-600 shadow-md cursor-pointer disabled:opacity-50"
        >
        ...
        <div className="relative flex items-center justify-center my-2">
          ...
          <span className="bg-slate-950 px-3 text-[10px] text-slate-500 uppercase font-semibold tracking-wider">
        ...
        <form onSubmit={handleSubmit} className="space-y-4">
          ...
          <button
            ...
            className="w-full py-3 rounded-xl bg-gradient-to-r from-indigo-600 to-violet-600 hover:from-indigo-500 hover:to-violet-500 text-white font-medium text-sm transition-all shadow-lg shadow-indigo-600/20 disabled:opacity-50 cursor-pointer"
          >
